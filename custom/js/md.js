...
(function() {
  ...
  var tocContents = gajus.contents({
    ...
    articles: $('#content').find('h1, h2, h3, h4').get()
  });
...
var initGitHubLinks = function() {
  ...
  //   </div>");
  $('.sidebar-wrapper #toc').append("<li class=sidebar-meta><a href='#' class=do-expand-all>Expand All</a> <a href='#top' style='margin-left:1.5em;' class=back-to-top>Back to Top</a></li>");
};
